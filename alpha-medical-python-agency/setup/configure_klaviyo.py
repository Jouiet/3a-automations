...
print(f"  ❌ Klaviyo connected to: Hendersonshop (WRONG)")
print(f"  ✅ Correct store: {SHOPIFY_STORE}")
print(f"  ✅ Public API Key: {KLAVIYO_PUBLIC_KEY[:20]}...")
print()
...
print("-" * 40)
print("1. In Klaviyo → Settings → Tracking")
...
print("-" * 40)
print("1. In Klaviyo → Flows → Create Flow")
print("2. Name: 'Pain Relief Guide Delivery'")
print("3. Trigger: 'Added to List' → Tag 'pain-relief-guide-download'")
print("4. Add Email:")
print("   Subject: 'Your FREE Pain Relief Guide is Ready 📥'")
...
print("     → Shopify Admin → Settings → Files → Upload")
print("     → Copy URL: https://cdn.shopify.com/s/files/.../Ultimate_Pain_Relief_Guide.pdf")
...
print("2. Check Klaviyo dashboard → People → Find your test email")
print("3. Verify:")
print("   ✓ Email appears in 'Pain Relief Guide Subscribers' list")
print("   ✓ Welcome email sent immediately")
print("   ✓ PDF download link works")
...
print("-" * 40)
print("1. Klaviyo Dashboard → Analytics")
...
print("="*80)
print()
print("✅ Email List Growth: +200-300 subscribers/month")
print("✅ Welcome Flow: 50%+ open rate, 20%+ click rate")
print("✅ Abandoned Cart Recovery: 5-8% conversion rate")
print("✅ Additional Revenue: $500-800/month")
print("✅ Customer Engagement: Automated nurturing")
print()
...
print("="*80)
print()
print("⚠️  This is MANUAL configuration - no automation possible")
print("⚠️  Estimated time: 30-45 minutes")
print("⚠️  Klaviyo Free Plan: Up to 250 contacts")
print("⚠️  After 250 contacts, paid plans start at $20/month")
print("⚠️  Test thoroughly before going live")
print()
