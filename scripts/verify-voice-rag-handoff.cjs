const { handleSearchKnowledgeBase, handleTransferCall } = require('../automations/agency/core/voice-telephony-bridge.cjs');
const fs = require('fs');
...
async function runTests() {
    ...
    try {
        ...
        if (result.found && result.result.includes('3A Automation')) {
