...
if (!configPath) {
  console.log(`
╔════════════════════════════════════════════════════════════════════════╗
║           VOICE WIDGET CLIENT GENERATOR - 3A Automation               ║
╚════════════════════════════════════════════════════════════════════════╝
...
const baseWidgetPath = path.join(__dirname, '../landing-page-hostinger/voice-assistant/voice-widget.js');
...
// Replace 3A Automation references with client name
widgetCode = widgetCode.replace(/3A Automation/g, client.name);
widgetCode = widgetCode.replace(/3a-automation\.com/g, client.domain);
...
const knowledge = {
  ...
  contact: {
    ...
    booking: config.knowledge?.bookingUrl || "/booking.html"
  }
};
