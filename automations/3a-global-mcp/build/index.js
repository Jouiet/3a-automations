...
server.registerResource("automations-registry", "3a://registry/automations", {
...
server.registerResource("client-registry", "3a://registry/clients", {
    ...
    contents: [{
            ...
            text: JSON.stringify({
                ...
                clients: Object.entries(clientRegistry.clients || {}).map(([id, config]) => ({
                    id,
                    name: config.name,
...
server.registerResource("pressure-matrix", "3a://sensors/pressure-matrix", {
    ...
    return {
        contents: [{
                ...
                text: JSON.stringify({
                    ...
                    sectors: Object.entries(freshMatrix.sectors || {}).map(([name, data]) => ({
                        name,
...
server.registerPrompt("client_health_report", {
...
server.registerPrompt("campaign_analysis", {
...
server.registerPrompt("automation_audit", {
...
server.registerTool("get_global_status", {
...
server.registerTool("get_tool_catalog", {
...
server.registerTool("chain_tools", {
    title: "Chain Tools",
