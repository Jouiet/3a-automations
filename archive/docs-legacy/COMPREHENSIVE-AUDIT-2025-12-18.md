...
1.  **Phase 1: Alignement et Stabilisation (Urgent - Prochaines 2 semaines)**
    ...
    *   **Action 1.3 (AEO):** Mettre en œuvre les recommandations AEO faciles : mettre à jour `robots.txt`, finaliser la stratégie `llms.txt` (créer le template Liquid), compresser les images.
