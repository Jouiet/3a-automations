...
- Donnees marche 2025-2026

**Principe**: Chaque persona est defini par ses **pain points reels** et les **automations specifiques** qui les resolvent.
...
| 4 | Commerce Local | 5k-30k€/mois | €390-790 | Quick Win | 23 |
| 5 | Marketing Agency | 20k-200k€/mois | €1399-5000 | Growth + Custom | 14 |
...
CA Mensuel:     5k - 50k€
Equipe:         1-3 personnes (souvent solo)
Niveau Tech:    Debutant a intermediaire
...
| Store Audit | Diagnostic complet | Script OK |
...
├── Configuration + tests
├── Documentation PDF
└── BONUS: Voice AI Booking

ROI ATTENDU: +€500-1500/mois (recovery cart seul)
PAYBACK: < 1 mois
```
...
Niveau Tech:    Intermediaire a avance
...
| VIP Tiers | Retention premium | Template Klaviyo |
...
├── Segmentation RFM complete
├── Dashboard Looker Studio
├── Support 60 jours
└── BONUS: Voice AI + WhatsApp + Rappels

+ ADD-ON CINEMATICADS (sur devis)
├── Video generation AI
├── Competitor analysis
└── Multi-ratio exports

ROI ATTENDU: +15-25% LTV, -20% CAC
PAYBACK: 60-90 jours
```
...
Niveau Tech:    Variable (souvent non-tech)
Maturite:       1-5 ans
```
...
├── Email Outreach Sequence (3 templates)
├── Integration CRM (Klaviyo/HubSpot)
├── Tests A/B
├── Support 30 jours
└── BONUS: Voice AI Booking + WhatsApp
...
└── Formation 30min si necessaire

ROI ATTENDU: -30% no-shows = +€500-2000/mois
PAYBACK: < 1 mois
```
...
├── Formation equipe (2h)
├── Integration workflow agence
├── Support prioritaire
└── Volume pricing sur credits AI

ADD-ON CINEMATICADS (sur devis):
├── Credits Vertex AI (Imagen 4, Veo 3.1)
├── Credits xAI Grok
├── Templates multi-clients
...
| 4 | E-commerce Scaler | Moyen | Moyen |
...
| 4 | Commerce Local | €390 | €290/mois | €3870 |
...
├── Objectif: 10 deals Quick Win (€3900)

PHASE 2 (Mois 3-4): Upsell + Essentials
├── Focus: Upsell Phase 1 + B2B Lead Hunter
├── Canaux: Email nurturing + Inbound
├── Objectif: 5 upgrades + 5 nouveaux (€5500)

PHASE 3 (Mois 5-6): Premium + Retainers
├── Focus: E-commerce Scaler + Retainers
├── Canaux: Referrals + Case studies
├── Objectif: 3 Growth + 10 retainers (€7100)
```
...
J'ai vu votre boutique [NOM_BOUTIQUE] sur Shopify.

Question directe: vous recuperez quel % de vos paniers abandonnes?

La moyenne e-commerce est 10-15% avec un simple flow email automatise.
Si vous etes en dessous (ou a 0%), vous laissez de l'argent sur la table.

Je peux auditer votre situation gratuitement et vous dire exactement
combien vous perdez chaque mois.

Interesse par un diagnostic en 24h?
...
Combien d'heures par semaine passez-vous a prospecter sur LinkedIn?

Avec [TYPE_ACTIVITE], je sais que trouver des clients qualifies
est le nerf de la guerre.

On a automatise ca: 400 leads/jour, scoring AI, emails personnalises.
3% reply rate vs 0.5% en cold outreach classique.

Un de mes clients [SIMILAR_PROFILE] a signe 3 deals en 2 semaines.

Ca vous interesse de voir comment?
...
Les no-shows, ca vous coute combien par mois?

Pour un [TYPE: restaurant/salon/garage], c'est souvent 10-20% du CA.

Solution simple: rappels WhatsApp automatiques 24h et 1h avant.
98% de taux d'ouverture (vs 20% SMS).
Et c'est gratuit (pas de cout par message).

Setup en 48h, fonctionne tout seul ensuite.
...
| Commerce Local | €300-500 | Owner = decideur | Reduce no-shows | Immediat |
...
| Commerce Local | Booking Google, reviews | Fermeture imminente |
| Agency | Recrutement creatifs | Budget bloque, saisonnalite |

---

## ANNEXE: AUTOMATIONS PAR PERSONA
...
| post-purchase | X | X | | | |
| win-back | | X | | | |
| linkedin-lead-scraper | | | X | | |
| email-outreach-sequence | | | X | | |
| whatsapp-booking-confirmation | | | | X | |
| grok-voice-telephony | | | | X | |
| cinematic-director | | X | | | X |
| ai-avatar-generator | | | | | X |
| store-audit | X | X | | | |
| ga4-source-report | X | X | | | |
