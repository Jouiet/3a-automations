# 3A AUTOMATION - STRATÉGIE PLUG-AND-PLAY
...
application_url = "https://dashboard.3a-automation.com"
...
[auth]
redirect_urls = ["https://dashboard.3a-automation.com/api/auth/shopify/callback"]
...
export async function exchangeToken(code: string, verifier: string) {
  const response = await fetch('https://a.klaviyo.com/oauth/token', {
    ...
    body: new URLSearchParams({
      ...
      redirect_uri: 'https://dashboard.3a-automation.com/api/auth/klaviyo/callback'
    })
  });
...
window.Voice3AConfig = {
  ...
  apiUrl: 'https://voice-api.3a-automation.com',
  language: 'fr',
...
<script src="https://cdn.3a-automation.com/voice-widget.min.js" async></script>
```
